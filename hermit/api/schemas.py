...
from hermit.settings import DEFAULT_OLLAMA_LLM_MODEL
...
class QueryRequest(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "examples": [
                {
                    "question": "How do I run the Hermit API?",
...
class IngestFileRequest(BaseModel):
    ...
    path: str = Field(
        description=(
            "Path to an existing **file** on the machine running the API (Hermit is local-first). "
